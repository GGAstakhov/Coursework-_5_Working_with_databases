...
class Data:
    ...
    def get_companies(self):
        """
        Generates data dictionaries for a table with data Companies
        """
    ...
    def get_vacancies(self):
        """
        Generates data dictionaries for a table with data Vacancies
        """
        ...
        if response.status_code == 200:
            ...
            for item in data['items']:
                ...
                if salary:
                    ...
                    self.salary_from.append('0')
                    self.salary_to.append('0')
                    self.currency.append('not specified')
        else:
